  ...
  (props, ref) => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
      ...
      if ('onChange' in rest && rest.onChange) {
        if (multiline) {
          (rest.onChange as React.ChangeEventHandler<HTMLTextAreaElement>)(e as React.ChangeEvent<HTMLTextAreaElement>);
        } else {
          (rest.onChange as React.ChangeEventHandler<HTMLInputElement>)(e as React.ChangeEvent<HTMLInputElement>);
        }
      }
    };
